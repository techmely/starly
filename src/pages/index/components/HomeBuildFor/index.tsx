  ...
  return (
    <section className="build-for-pro">
      ...
      <ul className="starly-container relative py-8 h-[210px]">
        ...
        <li className="absolute top-10 left-0 bg-gray-500 p-2 rounded-3xl">
        ...
        <li className="absolute top-10 right-0 bg-gray-500 p-2 rounded-3xl">
        ...
        <li className="absolute -bottom-10 left-0 bg-gray-500 p-2 rounded-3xl">
        ...
        <li className="absolute -bottom-10 right-0 bg-gray-500 p-2 rounded-3xl">
