...
export 'user.model.v1.pbenum.dart';
...
class UserProvider extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserProvider', package: const $pb.PackageName(_omitMessageNames ? '' : 'techmely.user.model.v1'), createEmptyInstance: create)
...
class UserMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UserMetadata', package: const $pb.PackageName(_omitMessageNames ? '' : 'techmely.user.model.v1'), createEmptyInstance: create)
...
class User extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'User', package: const $pb.PackageName(_omitMessageNames ? '' : 'techmely.user.model.v1'), createEmptyInstance: create)
