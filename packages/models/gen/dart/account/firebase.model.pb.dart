...
class AuthGoogleIdentityResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AuthGoogleIdentityResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'gen.go.account'), createEmptyInstance: create)
...
class FirebaseAuthConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'FirebaseAuthConfig', package: const $pb.PackageName(_omitMessageNames ? '' : 'gen.go.account'), createEmptyInstance: create)
...
class AuthGoogleIdentityRequestOptions extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AuthGoogleIdentityRequestOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'gen.go.account'), createEmptyInstance: create)
...
class AuthGoogleIdentityRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'AuthGoogleIdentityRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'gen.go.account'), createEmptyInstance: create)
