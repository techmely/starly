...
const AuthGoogleIdentityRequest$json = {
  ...
  '2': [
    {'1': 'config', '3': 1, '4': 1, '5': 11, '6': '.gen.go.account.FirebaseAuthConfig', '10': 'config'},
    {'1': 'options', '3': 2, '4': 1, '5': 11, '6': '.gen.go.account.AuthGoogleIdentityRequestOptions', '9': 0, '10': 'options', '17': true},
  ],
  '8': [
    {'1': '_options'},
  ],
...
final $typed_data.Uint8List authGoogleIdentityRequestDescriptor = $convert.base64Decode(
    'ChlBdXRoR29vZ2xlSWRlbnRpdHlSZXF1ZXN0EjoKBmNvbmZpZxgBIAEoCzIiLmdlbi5nby5hY2'
    'NvdW50LkZpcmViYXNlQXV0aENvbmZpZ1IGY29uZmlnEk8KB29wdGlvbnMYAiABKAsyMC5nZW4u'
    'Z28uYWNjb3VudC5BdXRoR29vZ2xlSWRlbnRpdHlSZXF1ZXN0T3B0aW9uc0gAUgdvcHRpb25ziA'
    'EBQgoKCF9vcHRpb25z');
