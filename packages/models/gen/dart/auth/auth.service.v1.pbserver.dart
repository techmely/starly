...
import 'auth.event.v1.pb.dart' as $0;
import 'auth.service.v1.pbjson.dart';

export 'auth.service.v1.pb.dart';

abstract class PreferencesServiceBase extends $pb.GeneratedService {
  $async.Future<$0.LoginResponse> get($pb.ServerContext ctx, $0.LoginRequest request);

  $pb.GeneratedMessage createRequest($core.String methodName) {
    switch (methodName) {
      case 'Get': return $0.LoginRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String methodName, $pb.GeneratedMessage request) {
    switch (methodName) {
      case 'Get': return this.get(ctx, request as $0.LoginRequest);
      default: throw $core.ArgumentError('Unknown method: $methodName');
    }
  }
