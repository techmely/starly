...
//  source: auth/auth.model.v1.proto
//
// @dart = 2.12
...
class Auth extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Auth', package: const $pb.PackageName(_omitMessageNames ? '' : 'techmely.auth.model.v1'), createEmptyInstance: create)
