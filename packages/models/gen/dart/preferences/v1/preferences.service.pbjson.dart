...
import 'preferences.event.pbjson.dart' as $4;
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> PreferencesServiceBase$messageJson = {
  '.gen.go.preferences.v1.GetPreferencesRequest': $4.GetPreferencesRequest$json,
  '.gen.go.preferences.v1.GetPreferencesResponse': $4.GetPreferencesResponse$json,
};
