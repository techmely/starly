...
import 'preferences.event.pbjson.dart' as $5;
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> PreferencesServiceBase$messageJson = {
  '.gen.go.preferences.v1.GetPreferencesRequest': $5.GetPreferencesRequest$json,
  '.gen.go.preferences.v1.GetPreferencesResponse': $5.GetPreferencesResponse$json,
};
