...
import 'preferences.event.pbjson.dart' as $3;
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> PreferencesServiceBase$messageJson = {
  '.gen.go.preferences.v1.GetPreferencesRequest': $3.GetPreferencesRequest$json,
  '.gen.go.preferences.v1.GetPreferencesResponse': $3.GetPreferencesResponse$json,
};
