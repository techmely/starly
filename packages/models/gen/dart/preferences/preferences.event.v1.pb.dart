...
//  source: preferences/preferences.event.v1.proto
//
// @dart = 2.12
...
class GetPreferencesRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetPreferencesRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'techmely.preferences.event.v1'), createEmptyInstance: create)
...
class GetPreferencesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetPreferencesResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'techmely.preferences.event.v1'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..hasRequiredFields = false
  ;
