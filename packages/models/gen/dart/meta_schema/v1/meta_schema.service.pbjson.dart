...
import 'meta_schema.event.pbjson.dart' as $4;
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> MetaSchemaServicePortServiceBase$messageJson = {
  '.gen.go.meta_schema.v1.GetMetaSchemaRequest': $4.GetMetaSchemaRequest$json,
  '.gen.go.meta_schema.v1.GetMetaSchemaResponse': $4.GetMetaSchemaResponse$json,
};
