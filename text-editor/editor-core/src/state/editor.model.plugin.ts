...
import { EditorProps, EditorView } from "../view/editor.view.index";
import { EditorState, EditorStateConfig } from "./editor.model.state";
import type { Transaction } from "./editor.model.transaction";
