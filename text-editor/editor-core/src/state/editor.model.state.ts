import type { Mark, Schema } from "../model";
import type { Plugin, StateField } from "./editor.model.plugin";
import { Selection, type TextSelection } from "./editor.model.selection";
import { Transaction } from "./editor.model.transaction";
...
/// The state of a techmely-editor editor is represented by an object of
...
export class EditorState {
  ...
  toJSON(pluginFields?: { [propName: string]: Plugin }): any {
    const result: any = { doc: this.doc.toJSON(), selection: this.selection.toJSON() };
