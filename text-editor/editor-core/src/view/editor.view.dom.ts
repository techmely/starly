...
export const domIndex = (node: Node) => {
...
export const parentNode = (node: Node): Node | null => {
...
export const textRange = (node: Text, from?: number, to?: number) => {
...
export const isEquivalentPosition = (
  node: Node,
  off: number,
  targetNode: Node,
  targetOff: number,
...
export const selectionCollapsed = (domSel: DOMSelectionRange) =>
  domSel.focusNode &&
